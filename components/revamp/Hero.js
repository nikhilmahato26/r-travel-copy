  ...
  const slides = [
    {
      ...
      subtitle: "Discover God's Own Country",
      title: 'Serene\nKerala',
      description: 'Houseboats, Tea Gardens & Backwaters',
      details: 'Cruise gently through palm-fringed backwater canals on a traditional private houseboat, stroll through Munnar\'s emerald tea hills, and explore the wildlife trails of Thekkady.',
      features: [
        { label: 'Days', value: '4-7 Days' },
        { label: 'Price', value: '11,999 INR' },
        { label: 'Type', value: 'Backwaters & Hills' },
      ],
    },
    {
      id: 2,
      ...
      subtitle: 'Explore Paradise on Earth',
      title: 'Majestic\nKashmir',
      description: 'Snow-Capped Peaks & Scenic Houseboats',
      details: 'Experience the breathtaking beauty of Srinagar\'s Dal Lake, the alpine slopes and snow sports of Gulmarg, and the picturesque valleys of Pahalgam.',
      features: [
        { label: 'Days', value: '6 Days' },
        { label: 'Price', value: '14,999 INR' },
        { label: 'Type', value: 'Snow & Valleys' },
      ],
    },
    {
      id: 3,
      ...
      subtitle: 'Land of Legends & Festivals',
      title: 'Vibrant\nGujarat',
      description: 'Spiritual Coastlines & Desert Festivals',
      details: 'Explore the sacred jyotirlingas of Dwarka and Somnath, marvel at the vast salt desert of the Rann Utsav festival, and see the Asiatic lions in Gir National Park.',
      features: [
        { label: 'Days', value: '3-6 Days' },
        { label: 'Price', value: '8,999 INR' },
        { label: 'Type', value: 'Heritage & Culture' },
      ],
    },
  ];
