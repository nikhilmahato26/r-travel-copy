    ...
    html: `
      <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:32px 24px;background:#fff;border-radius:16px;border:1px solid #e5e7eb">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:14px">
          <tr><td style="padding:8px 0;color:#6b7280;width:90px">Type</td><td style="padding:8px 0;color:#111;font-weight:600">${typeLabel}</td></tr>
          ${destination ? `<tr><td style="padding:8px 0;color:#6b7280;width:90px">Destination</td><td style="padding:8px 0;color:#111;font-weight:600">${destination}</td></tr>` : ''}
